    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4" style={{ backgroundColor: '#FAF7F2' }}>
      ...
      <div className="w-full max-w-sm rounded-2xl shadow-sm p-7" style={{ backgroundColor: '#ffffff', border: '1px solid #E8F0ED' }}>
        ...
        <button onClick={() => router.push('/dashboard')}
          className="w-full py-2.5 rounded-lg text-sm font-semibold border hover:bg-[#E8F0ED] transition-colors"
          style={{ borderColor: '#4A7C6F', color: '#4A7C6F', backgroundColor: 'transparent' }}>
